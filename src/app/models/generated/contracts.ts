...
import {
  ApiResponse, Todo, TodoCreateRequest, TodoUpdateRequest, TodoListResponse,
  ...
  User, LoginRequest, UserListResponse,
  CascadeResult,
} from './api.types';
...
export const Contracts = {
  ...
  getTodos: {
    command: 'get_todos',
    request: (options?: { page?: number; limit?: number; visibility?: string; filter?: unknown; sort?: unknown }) => options || {},
  ...
  updateTodo: {
    command: 'update_todo',
    request: (id: string, data: TodoUpdateRequest, visibility?: string) => ({ id, data, visibility }),
    response: {} as ApiResponse<Todo>,
  },
  deleteTodo: {
    command: 'delete_todo',
  ...
  getTasks: {
    command: 'get_tasks',
    request: (options?: { page?: number; limit?: number; visibility?: string; filter?: unknown; sort?: unknown; load?: string }) => options || {},
  ...
  updateTask: {
    command: 'update_task',
    request: (id: string, data: TaskUpdateRequest, visibility?: string) => ({ id, data, visibility }),
    response: {} as ApiResponse<Task>,
  },
  deleteTask: {
    command: 'delete_task',
  ...
  updateSubtask: {
    ...
    request: (id: string, data: SubtaskUpdateRequest, visibility?: string) => ({ id, data, visibility }),
    response: {} as ApiResponse<Subtask>,
  },
  deleteSubtask: {
  ...
  getCategories: {
    ...
    request: (options?: { page?: number; limit?: number; visibility?: string; filter?: unknown; load?: string }) => options || {},
  ...
  getProfiles: {
    ...
    request: (options?: { page?: number; limit?: number; visibility?: string; filter?: unknown }) => options || {},
  ...
  adminGetPaginated: {
    ...
    request: (dataType: string, skip: number, limit: number) => ({ data_type: dataType, skip, limit }),
    response: {} as ApiResponse<unknown>,
  },
  adminToggleDelete: {
