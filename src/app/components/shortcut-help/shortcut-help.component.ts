              ...
              <div>
                ...
                <div class="space-y-3">
                  <ng-container
                    *ngTemplateOutlet="
                      shortcutRow;
                      context: { keys: ['Ctrl', 'F'], desc: 'Toggle Filter Sidebar' }
                    "
                  ></ng-container>
                  <ng-container
                    *ngTemplateOutlet="
                      shortcutRow;
                      context: { keys: ['Ctrl', 'R'], desc: 'Reload Data' }
                    "
                  ></ng-container>
                  <ng-container
                    *ngTemplateOutlet="
              ...
              <div>
                ...
                <div class="space-y-3">
                  <ng-container
                    *ngTemplateOutlet="
                      shortcutRow;
                      context: { keys: ['Alt', 'H'], desc: 'Dashboard' }
                    "
                  ></ng-container>
                  <ng-container
                    *ngTemplateOutlet="
                      shortcutRow;
                      context: { keys: ['Alt', 'P'], desc: 'Projects' }
                    "
                  ></ng-container>
                  <ng-container
                  ...
                  <ng-container
                    *ngTemplateOutlet="
                      shortcutRow;
                      context: { keys: ['Alt', 'K'], desc: 'Kanban Board' }
                    "
                  ></ng-container>
                  <ng-container
                    *ngTemplateOutlet="
                      shortcutRow;
                      context: { keys: ['Alt', 'C'], desc: 'Categories' }
                    "
                  ></ng-container>
                  <ng-container
                    *ngTemplateOutlet="
                      shortcutRow;
                      context: { keys: ['Alt', 'S'], desc: 'Statistics' }
                    "
                  ></ng-container>
                  <ng-container
                  ...
                  <ng-container
                    *ngTemplateOutlet="
                      shortcutRow;
                      context: { keys: ['Alt', 'G'], desc: 'Shared Tasks' }
                    "
                  ></ng-container>
                  <ng-container
                    *ngTemplateOutlet="
                      shortcutRow;
                      context: { keys: ['Alt', 'L'], desc: 'Calendar' }
                    "
                  ></ng-container>
                  <ng-container
                    *ngTemplateOutlet="
                      shortcutRow;
                      context: { keys: ['Alt', 'U'], desc: 'Profile' }
                    "
                  ></ng-container>
                  <ng-container
